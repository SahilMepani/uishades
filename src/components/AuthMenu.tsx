...
const OAUTH_BTN =
  'flex h-11 w-full items-center justify-center gap-2 border border-ink/20 px-4 ' +
  'font-mono text-[14px] uppercase tracking-[0.16em] text-ink ' +
    ...
    <div className="flex flex-col gap-3">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2">
        <input
          ...
          className="h-11 w-full border border-ink/20 bg-paper-2 px-4 font-mono text-[18px] text-ink placeholder:text-mute focus:outline-none focus-visible:border-accent focus-visible:ring-2 focus-visible:ring-accent/30"
        />
        <button
          type="submit"
          disabled={submitting}
          className="flex h-11 items-center justify-center bg-ink px-4 font-mono text-[14px] uppercase tracking-[0.16em] text-paper transition-colors duration-200 ease-out hover:bg-ink/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60 disabled:cursor-default disabled:opacity-60"
        >
